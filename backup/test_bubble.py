...
from PyQt6.QtCore import QAbstractListModel, QMargins, QPoint, Qt
from PyQt6.QtGui import QColor, QPen
from PyQt6.QtWidgets import QApplication, QWidget, QPushButton, QVBoxLayout, QHBoxLayout, QListWidget
...
class MessageDelegate(QStyledItemDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        pen = QPen()
        painter.setPen(pen)
        painter.drawText(textrect, Qt.TextFlag.TextWordWrap, text)
...
class MessageModel(QAbstractListModel):
    ...
    def data(self, index, role):
        if role == Qt.ItemDataRole.DisplayRole:
            # Here we pass the (user, message) tuple to the delegate.
